...
extern u32 read_rfreg(_adapter *padapter, u8 rfpath, u32 addr, u32 bitmask);
extern void write_rfreg(_adapter *padapter, u8 rfpath, u32 addr, u32 bitmask, u32 val);
...
extern void	SetPowerTracking(PADAPTER padapter, u8 enable);
