...
_func_enter_;
	...
	pdvobjpriv->RtNumInPipes = NumInPipes;
	pdvobjpriv->RtNumOutPipes = NumOutPipes;
	
	printk("nr_endpoint=%d, in_num=%d, out_num=%d\n\n", pdvobjpriv->nr_endpoint, NumInPipes, NumOutPipes);
