...
_func_enter_;   	
	...
	*/
	...
	pxmitpriv->pxmit_frame_buf = (u8 *)N_BYTE_ALIGMENT((uint)(pxmitpriv->pallocated_frame_buf), 4);
	...
	pxmitpriv->pxmitbuf = (u8 *)N_BYTE_ALIGMENT((uint)(pxmitpriv->pallocated_xmitbuf), 4);
	...
	for (i = 0; i < NR_XMITBUFF; i++)
	{
		...
		pxmitbuf->pbuf = (u8 *)N_BYTE_ALIGMENT((uint)(pxmitbuf->pallocated_buf), XMITBUF_ALIGN_SZ);
...
_func_enter_;
	...
	if (pxframe !=  NULL)
	{
		...
		if(pxmitpriv->free_xmitframe_cnt==2)
		{
