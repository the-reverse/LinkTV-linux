...
)
{
	...
	switch(pLed->LedPin)
	{
		...
		case LED_PIN_LED0:
			...
			write8(padapter, REG_LEDCFG2, LedCfg&0xf0); // SW control led0 on.
			//RT_TRACE(COMP_LED, DBG_LOUD, ("SwLedOn LED0\n"));
			
			break;

		case LED_PIN_LED1:
			LedCfg = read8(padapter, (REG_LEDCFG2 + 1));
			write8(padapter, (REG_LEDCFG2 + 1), LedCfg&0x0f); // SW control led1 on.
...
)
{
	...
	switch(pLed->LedPin)
	{
		...
		case LED_PIN_LED1:
			...
			write8(padapter, (REG_LEDCFG2+1), (LedCfg|BIT3));
