...
#define TSMCImgArrayLength	ImgArrayLength
#define UMCImgArrayLength	ImgArrayLength
extern u8 Rtl8192CUFwImgArray[ImgArrayLength];
#define MainArrayLength 1
extern u8 Rtl8192CUFwMainArray[MainArrayLength];
#define DataArrayLength 1
extern u8 Rtl8192CUFwDataArray[DataArrayLength];
