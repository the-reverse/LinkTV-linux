...
)
{
	...
	if(((pHalData->EEPROMDID==0x8176) && (
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7176) ||// Realtek, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7177) ||// Toshiba Liteon, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7178) ||// Toshiba Askey, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7179) ||// Toshiba Arcadyan, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7180) ||// Toshiba QMI, 1x1
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x7181) ||// Acer Liteon, 1x1
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x7182) ||// Acer Foxconn, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7191) ||// Samsung Foxconn, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7192) ||// Samsung Askey, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7193) ||// Samsung WNC, 1x1
		(pHalData->EEPROMSVID == 0x1A3B && pHalData->EEPROMSMID == 0x1A39) ||// AzWave, 1x1
		(pHalData->EEPROMSVID == 0x1462 && pHalData->EEPROMSMID == 0x824A) ||// MSI, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7194) ||// Lenovo Foxconn/Liteon , 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7150) ||// Realtek, 1x1
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6176) ||// Realtek, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6177) ||// Toshiba Liteon, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6178) ||// Toshiba Askey, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6179) ||// Toshiba Arcadyan, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6180) ||// Toshiba QMI, 1x1 Comb
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x6181) ||// Acer Liteon, 1x1 Comb
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x6182) ||// Acer Foxconn, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6191) ||// Samsung Foxconn, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6192) ||// Samsung Askey, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6193) ||// Samsung WNC, 1x1 Comb
		(pHalData->EEPROMSVID == 0x1A3B && pHalData->EEPROMSMID == 0x2A57) ||// AzWave, 1x1 Comb
		(pHalData->EEPROMSVID == 0x1462 && pHalData->EEPROMSMID == 0x874A) ||// MSI, 1x1 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6150)))	||// Realtek, 1x1 Comb
	    ((pHalData->EEPROMDID==0x8178) && (
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x6178) ||// Realtek, 2x2 Comb
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x6179) ||// Acer Liteon, 2x2 Comb
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x6180) ||// Acer Foxconn, 2x2 Comb
		(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x7178) ||// Realtek, 2x2
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x7179) ||// Acer Liteon, 2x2
		(pHalData->EEPROMSVID == 0x1025 && pHalData->EEPROMSMID == 0x7180))))// Acer Foxconn, 2x2
	{
		...
		{	
			case EEPROM_CID_DEFAULT:
				if(pHalData->EEPROMDID==0x8176)
				{
					...
					else if((pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x8200) ||
							...
							(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x9200))
					{
						...
						if((pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x8200) ||												
												(pHalData->EEPROMSVID == 0x10EC && pHalData->EEPROMSMID == 0x9199) )
						{
							pHalData->CustomerID = RT_CID_819x_BITLAND;
						}
					}
	...
	)
{
	...
	//PlatformEFIOWrite4Byte(Adapter, REG_HIMRE, IMR8190_DISABLED);	// by tynli
...
static u32 rtl8192ce_hal_init(PADAPTER Adapter)
{
	...
	u8	eRFPath;
	u32	i;
	BOOLEAN bSupportRemoteWakeUp, isNormal, is92C;
