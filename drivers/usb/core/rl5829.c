...
void USBPHY_SetReg_Default_30(void)
{
   ...
   USBPHY_SetReg(USBPHY_30, USBPHY_30_set_xcvr_autok(0x1) |       // POR = 1
                            USBPHY_30_set_xcvr_SC(0x3) |          // POR = 3, PLL_C
                            USBPHY_30_set_xcvr_CP(0x1));          // POR = 4
   }
}

void USBPHY_SetReg_Default_30_port(int port, int cp, int sc)
{
   if(is_jupiter_cpu())
   {
   USBPHY_SetReg_port(port, USBPHY_30, USBPHY_30_set_xcvr_autok(0x1) |       // POR = 1
                            USBPHY_30_set_xcvr_SC(sc & 0xf) |          // POR = 3, PLL_C
                            USBPHY_30_set_xcvr_CP(cp & 0x7));          // POR = 4
   }
}

void USBPHY_SetReg_Default_31(int sr)
{
   if(is_venus_cpu() || is_neptune_cpu() || is_mars_cpu())
   {
   ...
   USBPHY_SetReg(USBPHY_31, USBPHY_31_set_xcvr_call_host(0x1) |   // POR = 1
                            ...
                            USBPHY_31_set_xcvr_zo_en(0x1) |       // POR = 1
                            USBPHY_31_set_xcvr_SD(0x1) |          // POR = 1
                            USBPHY_31_set_xcvr_SR(sr & 0x7));          // POR = 4, PLL_R
   } else if(jupiter_a == 1){
   USBPHY_SetReg(USBPHY_31, USBPHY_31_set_xcvr_call_host(0x1) |   // POR = 1
                            USBPHY_31_set_xcvr_zeres_sel(0x0) |   // POR = 0
                            USBPHY_31_set_xcvr_zo_en(0x1) |       // POR = 1
...
void USBPHY_SetReg_Default_31_port(int port, int sr)
{
   if(is_jupiter_cpu())
   {
   if(cpu_rev_num() >= 2){
   USBPHY_SetReg_port(port, USBPHY_31, USBPHY_31_set_xcvr_call_host(0x1) |   // POR = 1
                            USBPHY_31_set_xcvr_zeres_sel(0x0) |   // POR = 0
                            USBPHY_31_set_xcvr_zo_en(0x1) |       // POR = 1
                            USBPHY_31_set_xcvr_SD(0x1) |          // POR = 1
                            USBPHY_31_set_xcvr_SR(sr & 0x7));          // POR = 4, PLL_R
...
void USBPHY_SetReg_Default_32(int sen, int sh)
{
   ...
   {
   USBPHY_SetReg(USBPHY_32, USBPHY_32_set_SEN((sen & 0x9)) |      // POR = 8
                            USBPHY_32_set_SH((sh & 0x8)));        // POR = 5, swing
   }
}
...
{
	printk("#@# cfyeh-debug %s(%d) dr %x\n", __func__, __LINE__, dr);
   // for venus
   if(is_venus_cpu())
   {
...
//#ifdef CONFIG_REALTEK_VENUS_USB_1261_ECO
   ...
   {
   if(cpu_rev_num() >= 2 || (jupiter_a == 1)){
   USBPHY_SetReg(USBPHY_33, USBPHY_33_set_HSXMPTPDEN(0x1) |       // POR = 1, hi-speed XCVR power down enable
                            USBPHY_33_set_xcvr_CAL(0x1) |         // POR = 1
                            USBPHY_33_set_xcvr_DB(0x0) |          // POR = 4
			    USBPHY_33_set_xcvr_DR(dr & 0x7)  	  // POR = 0
			    );
   } else {
   USBPHY_SetReg(USBPHY_33, USBPHY_33_set_HSXMPTPDEN(0x0) |       // POR = 1, hi-speed XCVR power down enable
                            USBPHY_33_set_xcvr_CAL(0x1) |         // POR = 1
                            USBPHY_33_set_xcvr_DB(0x0) |          // POR = 4
			    USBPHY_33_set_xcvr_DR(dr & 0x7)  	  // POR = 0
			    );
...
{
	printk("#@# cfyeh-debug %s(%d) port %d dr %x\n", __func__, __LINE__, port, dr);
   // for venus
   if(is_venus_cpu())
   {
...
/*
   ...
   USBPHY_SetReg_port(port, USBPHY_33, USBPHY_33_set_HSXMPTPDEN(0x0) |       // POR = 1, hi-speed XCVR power down enable
                            USBPHY_33_set_xcvr_CAL(0x1) |         // POR = 1
                            USBPHY_33_set_xcvr_DB(0x0) |          // POR = 4
			    USBPHY_33_set_xcvr_DR(dr & 0x7)  	  // POR = 0
			    );
...
void USBPHY_SetReg_Default_35(int src)
{
   ...
   USBPHY_SetReg(USBPHY_35, USBPHY_35_set_SE0_LVL(0x1) |          // POR = 1
                            USBPHY_35_set_xcvr_SRC((src & 0x7)) | // POR = 7,  slew rate control
                            USBPHY_35_set_Force_XTL_ON(0x0) |     // POR = 0
                            USBPHY_35_set_xcvr_nsqdly(0x1));      // POR = 1
   }
   else if(is_jupiter_cpu())
   {
   USBPHY_SetReg(USBPHY_35, USBPHY_35_set_SERX_TH(0x1) |          // POR = 1
                            USBPHY_35_set_xcvr_SP(0x0) |          // POR = 0
                            USBPHY_35_set_xcvr_SRC((src & 0x7)) | // POR = 2,  slew rate control
                            USBPHY_35_set_Force_XTL_ON(0x0) |     // POR = 0
                            USBPHY_35_set_xcvr_nsqdly(0x1));      // POR = 1
   }
}
...
void USBPHY_SetReg_Default_35_port(int port, int src)
{
   ...
   {
   USBPHY_SetReg_port(port, USBPHY_35, USBPHY_35_set_SERX_TH(0x1) |          // POR = 1
                            USBPHY_35_set_xcvr_SP(0x0) |          // POR = 0
                            USBPHY_35_set_xcvr_SRC((src & 0x7)) | // POR = 2,  slew rate control
                            USBPHY_35_set_Force_XTL_ON(0x0) |     // POR = 0
                            USBPHY_35_set_xcvr_nsqdly(0x1));      // POR = 1
...
void USBPHY_SetReg_Default_39(int tx_delay)
{
	printk("#@# cfyeh-debug %s(%d) tx_delay %d\n", __func__, __LINE__, tx_delay);
   if(is_mars_cpu())// for mars
   {
	 USBPHY_SetReg(USBPHY_39, USBPHY_39_set_utmi_pos_out(0x1) |     // POR = 1
				  ...
				  USBPHY_39_set_tx_delay(tx_delay & 0x3) |		// POR = 1
   ...
   else if(is_jupiter_cpu())
   {
	 USBPHY_SetReg(USBPHY_39, USBPHY_39_set_utmi_pos_out(0x1) |     // POR = 1
				  ...
				  USBPHY_39_set_slb_sel(0x0) |		// POR = 0
				  USBPHY_39_set_auto_sel(0x1) |		// POR = 1
				  USBPHY_39_set_tx_delay(tx_delay & 0x3) |		// POR = 2
				  USBPHY_39_set_slb_fs(0x0));		// POR = 0
   }
}
...
void USBPHY_SetReg_Default_3B_port2_b(void)
{
	 USBPHY_SetReg_port(2, USBPHY_3B, USBPHY_3B_set_force_serial(0x0) |		// POR = 0
	                          USBPHY_3B_set_serial_mode(0x0) |		// POR = 0
	                          USBPHY_3B_set_force_suspendm(0x1) |		// POR = 0
	                          USBPHY_3B_set_suspendm_mode(0x0) |		// POR = 1
	                          USBPHY_3B_set_force_txse0(0x0) |		// POR = 0
	                          USBPHY_3B_set_txse0_mode(0x0) |		// POR = 0
	                          USBPHY_3B_set_force_txenable_n(0x0) |		// POR = 0
	                          USBPHY_3B_set_txenable_n_mode(0x1));		// POR = 1
...
// for jupiter
void USBPHY_SetReg_Default_3C(int chrip_en)
{
	printk("#@# cfyeh-debug %s(%d) chrip_en %x\n", __func__, __LINE__, chrip_en);
	if(is_jupiter_cpu())
		 USBPHY_SetReg(USBPHY_3C, USBPHY_3C_set_slb_rst_force_select(0x1) |		// POR = 1
					  USBPHY_3C_set_no_use(0x3) |				// POR = 3
					  USBPHY_3C_set_host_chrip_en(chrip_en & 0x1) |			// POR = 1
					  USBPHY_3C_set_usbphy_debug_select(0x0) |		// POR = 0
					  USBPHY_3C_set_fs_ls_termen_select(0x3));		// POR = 3
}

void USBPHY_SetReg_Default_3E(int en_otg)
{
	if(is_jupiter_cpu())
		 USBPHY_SetReg(USBPHY_3E, USBPHY_3E_set_en_otg(en_otg & 0x1));
}
...
void UTMI_VendorIF_Init(void){
	...
	if((is_venus_cpu() || is_neptune_cpu()))
		Max_port_num = 1;
	else if(is_mars_cpu() || is_jupiter_cpu())
		Max_port_num = 2;
...
#define PARAM_SIZE	0x10
	int param[PARAM_SIZE];
	int param1[PARAM_SIZE];
	int param2[PARAM_SIZE];
	int i=0;
	...
	if(is_jupiter_cpu()) {
		param[0] = 0x8;		// reg 32 sh, POR = 8, 4bit;
		if(cpu_rev_num() >= 2)
			param[1] = 0x6;		// reg 35 src, POR = 2, 3bit;
		else
			param[1] = 0x2;		// reg 35 src, POR = 2, 3bit;
		param[2] = 0x9;		// reg 36 senh, POR = 9, 4bit;
		param[3] = 0x9;		// reg 32 sen, POR = 9, 4bit;
		param[4] = 0x1;		// reg 33 dr, POR = 1, 3bit;
		param[5] = 0x0;		// reg 31 sr, 3bit;
		param[6] = 0x1;		// reg 30 cp, 3bit;
		if(cpu_rev_num() >= 2)
			param[7] = 0x3;		// reg 30 sc, 4bit;
		else
			param[7] = 0x1;		// reg 30 sc, 4bit;
	}
	// for venus and neptune
	if((is_venus_cpu() || is_neptune_cpu()))
	...
	else
	{
		...
		// set MARS_USB_HOST_OTGMUX=0x001e01ff for otg
		outl(0x001e01ff, MARS_USB_HOST_OTGMUX); // for device
		//outl(0x01e001ff, MARS_USB_HOST_OTGMUX); // for host mars A
		//outl(0x01e001fe, MARS_USB_HOST_OTGMUX); // for host mars > A
	...
	else if(is_jupiter_cpu())// for jupiter
	{
		unsigned int value, bit8 = 0, bit9 = 0, type = 0;
		char *value_ptr;
		printk("[usb_param] setting for jupiter\n");
		// check system_parameters
                value_ptr = parse_token(platform_info.system_parameters, "JUPITER_A");
                if(value_ptr && strlen(value_ptr)) {
                        if(!strcmp(value_ptr, "ON") || !strcmp(value_ptr, "on"))
                                type = 1;
                } else {
                       type = 0;
                }
		...
		//       = 10 BGA1881 --> A
		//       = 11 BGA1185 --> B
		value = readl((unsigned int)0xb801bd28);
		bit8 = (value >> 8) & 0x1;
		bit9 = (value >> 9) & 0x1;
		//printk("#######[cfyeh-debug] %s(%d) jupiter bit8 %d bit9 %d\n", __func__, __LINE__, bit8, bit9);
		if(cpu_rev_num() >= 2){
			printk("#######[cfyeh-debug] %s(%d) jupiter %s\n", __func__, __LINE__, cpu_rev_num() == 2 ? "C" : "D");
			jupiter_a = 0;
			param[5] = 0x7;		// reg 31 sr, 3bit;
		} else if((bit8 != bit9) || type){
			printk("#######[cfyeh-debug] %s(%d) jupiter A\n", __func__, __LINE__);
			jupiter_a = 1;
		} else {
			printk("#######[cfyeh-debug] %s(%d) jupiter B.2\n", __func__, __LINE__);
			jupiter_a = 0;
			param[5] = 0x7;		// reg 31 sr, 3bit;
		}
		...
		printk("[usb_param] set port two for otg!\n");
		outl(0x1, MARS_USB_HOST_OTG); // enable otg
		USBPHY_SetReg_Default_3E(1);
#else
		printk("[usb_param] set port two for host!\n");
		outl(0x0, MARS_USB_HOST_OTG); // disable otg
		USBPHY_SetReg_Default_3E(0);
#endif /* USB_MARS_OTG_ENABLE_IN_PORT_TWO */
	}
	...
	check_boot_code_param((int *)&param[0], PARAM_SIZE, usb_param);
	if(is_mars_cpu() || is_jupiter_cpu())
	{
		for(i=0; i<PARAM_SIZE; i++)
		{
			...
			param2[i]=param[i];
			if(cpu_rev_num() >= 2)
				param2[0] = 0xa;		// reg 32 sh, POR = 8, 4bit;
		}
		check_boot_code_param((int *)&param1[0], PARAM_SIZE, usb1_param);
		check_boot_code_param((int *)&param2[0], PARAM_SIZE, usb2_param);
	}

	UTMI_VendorIF_Init();

#if 0
	printk("#@# cfyeh-debug %s(%d) 30 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_20)), (USBPHY_GetReg(2, USBPHY_20)));
	printk("#@# cfyeh-debug %s(%d) 31 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_21)), (USBPHY_GetReg(2, USBPHY_21)));
	printk("#@# cfyeh-debug %s(%d) 32 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_22)), (USBPHY_GetReg(2, USBPHY_22)));
	printk("#@# cfyeh-debug %s(%d) 33 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_23)), (USBPHY_GetReg(2, USBPHY_23)));
	printk("#@# cfyeh-debug %s(%d) 34 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_24)), (USBPHY_GetReg(2, USBPHY_24)));
	printk("#@# cfyeh-debug %s(%d) 35 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_25)), (USBPHY_GetReg(2, USBPHY_25)));
	printk("#@# cfyeh-debug %s(%d) 36 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_26)), (USBPHY_GetReg(2, USBPHY_26)));
	printk("#@# cfyeh-debug %s(%d) 37 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_27)), (USBPHY_GetReg(2, USBPHY_27)));
	printk("#@# cfyeh-debug %s(%d) 38 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_28)), (USBPHY_GetReg(2, USBPHY_28)));
	printk("#@# cfyeh-debug %s(%d) 39 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_29)), (USBPHY_GetReg(2, USBPHY_29)));
	printk("#@# cfyeh-debug %s(%d) 3a 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_2A)), (USBPHY_GetReg(2, USBPHY_2A)));
	printk("#@# cfyeh-debug %s(%d) 3b 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_2B)), (USBPHY_GetReg(2, USBPHY_2B)));
	printk("#@# cfyeh-debug %s(%d) 3c 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_2C)), (USBPHY_GetReg(2, USBPHY_2C)));
	printk("#@# cfyeh-debug %s(%d) 3d 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_2D)), (USBPHY_GetReg(2, USBPHY_2D)));
	printk("#@# cfyeh-debug %s(%d) 3e 0x%.2x 0x%.2x\n", __func__, __LINE__, (USBPHY_GetReg(1, USBPHY_2E)), (USBPHY_GetReg(2, USBPHY_2E)));
#endif
	if(is_jupiter_cpu()) {
		USBPHY_SetReg_Default_30_port(1, param[6], param[7]);
		USBPHY_SetReg_Default_30_port(2, param[6], param[7]);
	} else
		USBPHY_SetReg_Default_30();

	if((is_venus_cpu() || is_neptune_cpu()))
	{
		USBPHY_SetReg_Default_31(0);
	...
	if(is_mars_cpu() || is_jupiter_cpu())
	{
		...
		if(is_jupiter_cpu() && (jupiter_a == 0) && !(cpu_rev_num() >= 2))
			USBPHY_SetReg_Default_3B_port2_b();
	}
	...
	else if(is_mars_cpu() || is_jupiter_cpu())
	{
		...
		if(is_jupiter_cpu()) {
			printk("[usb1_param] usbphy reg 31, set sr = 0x%x, get sr = 0x%x, 3bit\n", \
					param1[5], (USBPHY_GetReg(1, USBPHY_21)) & 0x7);
			printk("[usb1_param] usbphy reg 30, set cp = 0x%x, get cp = 0x%x, 3bit\n", \
					param2[6], (USBPHY_GetReg(1, USBPHY_20)) & 0x7);
			printk("[usb1_param] usbphy reg 30, set sc = 0x%x, get sc = 0x%x, 4bit\n", \
					param2[7], (USBPHY_GetReg(1, USBPHY_20)>>3) & 0xf);
		}
		...
		if(is_jupiter_cpu()) {
			printk("[usb2_param] usbphy reg 31, set sr = 0x%x, get sr = 0x%x, 3bit\n", \
					param2[5], (USBPHY_GetReg(2, USBPHY_21)) & 0x7);
			printk("[usb2_param] usbphy reg 30, set cp = 0x%x, get cp = 0x%x, 3bit\n", \
					param2[6], (USBPHY_GetReg(2, USBPHY_20)) & 0x7);
			printk("[usb2_param] usbphy reg 30, set sc = 0x%x, get sc = 0x%x, 4bit\n", \
					param2[7], (USBPHY_GetReg(2, USBPHY_20)>>3) & 0xf);
		}
	}
...
EXPORT_SYMBOL (USBPHY_SetReg_Default_39);
