...
2. Use the parameter "rtl2832u_rc_mode" to choose rc protocol.
...
3.modify "RT_use_rc_protocol" to select rc protocol
	...
	if rtl2832u_rc_mode   2     use nec protocol
	if rtl2832u_rc_mode   3     disable rc function

4.Must to edit KEY_MAP, KEY_MAP is define in "rtl2832u_rc_keys_map_table"
