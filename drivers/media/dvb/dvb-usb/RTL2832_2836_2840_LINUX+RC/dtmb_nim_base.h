...
// RTL2836B DTMB FC0013 extra module
typedef struct RTL2836B_DTMB_FC0013_EXTRA_MODULE_TAG RTL2836B_DTMB_FC0013_EXTRA_MODULE;
struct RTL2836B_DTMB_FC0013_EXTRA_MODULE_TAG
{
	// Extra variables
	unsigned long LnaUpdateWaitTimeMax;
	unsigned long LnaUpdateWaitTime;
...
struct DTMB_NIM_MODULE_TAG
{
	...
	union														///<   NIM extra module used by driving module
	{
		...
		RTL2836B_DTMB_FC0013_EXTRA_MODULE Rtl2836bDtmbFc0013;
	}
	Extra;
