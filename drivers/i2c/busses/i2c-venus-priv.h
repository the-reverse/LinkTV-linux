...
#define MODLE_NAME_JUPITER          "Jupiter"
#define MODLE_NAME_MARS             "Mars"
#define MODLE_NAME_NEPTUNE          "Neptune"
#define MODLE_NAME_VENUS            "Venus"
...
{    
    ...
    struct {
        unsigned char  valid;   		// is gpio map is valid?
        // gpio index
        unsigned char   scl;
        unsigned char   sda;        
                   
        // mux pad for I2C/GPIO        
        unsigned long  muxpad;         // 0 : if no used, others: use gpio switch       
