...
////////////////////////////////////////////////////////////////
// for Jupiter of Later
////////////////////////////////////////////////////////////////
#define SYS_SOFT_RESET2     (0xb8000004)
  #define I2C_0_REST_N               (0x1 << 27)
  #define I2C_1_REST_N               (0x1 << 26)
  
#define SYS_CLOCK_ENABLE2   (0xb8000010)
  #define CLK_EN_I2C_0               (0x1 << 16)
  #define CLK_EN_I2C_1               (0x1 << 15)

#define MIS_DUMMY1          (0xb801b068)
  #define WRITE_ENABLE2       (0x00000001<<31)            
  #define IC1_DATA_DEL_EN(x)  ((x & 0x1)<<23)
  #define IC1_DATA_DEL(x)     ((x & 0x7F)<<16)
  
  #define WRITE_ENABLE1       (0x00000001<<15)            
  #define IC_DATA_DEL_EN(x)   ((x & 0x1)<<7)
  #define IC_DATA_DEL(x)      ((x & 0x7F))            
  
  #define IC_DATA_DEL_1T      0x00
  #define IC_DATA_DEL_2T      0x01
  #define IC_DATA_DEL_3T      0x10
  #define IC_DATA_DEL_4T      0x12
  #define IC_DATA_DEL_6T      0x40
  #define IC_DATA_DEL_9T      0x44
  #define IC_DATA_DEL_12T     0x60
  #define IC_DATA_DEL_15T     0x68  
