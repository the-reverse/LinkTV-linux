...
#include <asm/offset.h>
		...
		bnez    k1, 1f
		addu    k1, k1, 1
		LONG_S  sp, %lo(interrupt_tmp)(k0)
		li      sp, 0x90004000 - 32
1:		LONG_S  k1, %lo(interrupt_cnt)(k0)
2:
		.set    pop
		.endm
#endif
...
8:		move	k0, sp
		...
		LONG_S	$28, PT_R28(sp)
		LONG_S	$31, PT_R31(sp)
#if defined(CONFIG_REALTEK_USE_DMEM) || defined(CONFIG_REALTEK_SBSS_IN_DMEM_ADVANCED) \
 || defined(CONFIG_REALTEK_USE_FAST_INTERRUPT) || defined(CONFIG_REALTEK_USE_FAST_INTERRUPT_AND_DMEM)
		get_saved_sp
		ori	$28, k1, _THREAD_MASK
#else
		ori	$28, sp, _THREAD_MASK
