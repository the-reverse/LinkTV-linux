...
#define USBPHY_2C                            0xD4
#define USBPHY_2D                            0xD5
#define USBPHY_2E                            0xD6
...
// jupiter
#define USBPHY_34_set_DB(data)               USBPHY_34_set_xcvr_SE(data)
...
// jupiter
#define USBPHY_35_set_SERX_TH(data)          USBPHY_35_set_TPC_EN(data)
...
// for jupiter
#define USBPHY_3D                            0xF5

#define USBPHY_3C                            0xF4
#define USBPHY_3C_set_slb_rst_force_select(data)	(0x01&((data)<<7))
#define USBPHY_3C_set_no_use(data)			(0x03&((data)<<5))
#define USBPHY_3C_set_host_chrip_en(data)		(0x01&((data)<<4))
#define USBPHY_3C_set_usbphy_debug_select(data)		(0x03&((data)<<2))
#define USBPHY_3C_set_fs_ls_termen_select(data)		(0x03&((data)<<0))

#define USBPHY_3E                            0xF6
#define USBPHY_3E_set_en_otg(data)     (0x04&((data)<<2))
