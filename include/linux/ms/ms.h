...
#define MS_ERR_TIMEOUT	1
#define MS_ERR_BADCRC	2
#define MS_ERR_RMOVE	3
#define MS_ERR_FAILED	4
#define MS_ERR_INVALID	5
...
//#define MS_REG_WRITE	(1 << 6)
//#define MS_REG_READ	(1 << 7)
#define MS_DATA_WRITE	(1 << 8)
#define MS_DATA_READ	(1 << 9)
#define MS_DATA_STREAM	(1 << 10)
