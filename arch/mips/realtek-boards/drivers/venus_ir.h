...
#define ISO_IR_PSR				((volatile unsigned int *)0xb801be00)
#define ISO_IR_PER				((volatile unsigned int *)0xb801be04)
#define ISO_IR_SF				((volatile unsigned int *)0xb801be08)
#define ISO_IR_DPIR				((volatile unsigned int *)0xb801be0c)
#define ISO_IR_CR				((volatile unsigned int *)0xb801be10)
#define ISO_IR_RP				((volatile unsigned int *)0xb801be14)
#define ISO_IR_SR				((volatile unsigned int *)0xb801be18)
#define ISO_IR_RAW_CTRL			((volatile unsigned int *)0xb801be1c)
#define ISO_IR_RAW_FF			((volatile unsigned int *)0xb801be20)
#define ISO_IR_RAW_SAMPLE_TIME	((volatile unsigned int *)0xb801be24)
#define ISO_IR_RAW_WL			((volatile unsigned int *)0xb801be28)
#define ISO_IR_RAW_DEB			((volatile unsigned int *)0xb801be2c)
#define ISO_IR_CTRL_RC6			((volatile unsigned int *)0xb801be38)
