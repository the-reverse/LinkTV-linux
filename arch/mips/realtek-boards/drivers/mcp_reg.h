...
#define JUPITER_CP_OTP_LOAD       0xb801519C    /* for Jupiter only */    
...
#define SET_MCP_OTP_LOAD(x)       writel((x), (volatile unsigned int*) JUPITER_CP_OTP_LOAD)     /* for Jupiter only */
...
#define GET_MCP_OTP_LOAD(x)       readl((volatile unsigned int*) JUPITER_CP_OTP_LOAD)     /* for Jupiter only */
