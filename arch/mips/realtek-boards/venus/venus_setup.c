...
char *rtk_dmp_system_type[]={"Realtek DMP/Venus", "Realtek DMP/Neptune", "Realtek DMP/Mars", "Realtek DMP/Jupiter"};

const char *get_system_type(void)
{
	int cpunum=platform_info.cpu_id&0xf;
	
	if(cpunum>3)
		return NULL;
	else
		return rtk_dmp_system_type[cpunum];
}
